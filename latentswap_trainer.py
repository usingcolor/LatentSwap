...
shutil.copy(args.model_config, os.path.join(save_path, "model.yaml"))
shutil.copy(args.train_config, os.path.join(save_path, "train.yaml"))

model_hparams = OmegaConf.load(args.model_config)
latentswap_model = LatentSwap(model_hparams)
